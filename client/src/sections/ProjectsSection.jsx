  ...
  return (
    <section className="projects section" id="projects">
      <div className="section-heading reveal">
        <div>
          <p className="eyebrow">01 — PROJECTS & CRAFT</p>
          <h2>I build things <em>people use.</em></h2>
        </div>
        <span>{projects.length} CASE STUDIES</span>
      </div>
      
      <p className="section-lead reveal">
        These started as real problems — managing a business, simplifying operations, 
        organizing data, or making information easier to access. Here is what I built.
      </p>
        ...
        {projects.map((p, i) => {
          ...
          return (
            <Link 
              ...
              className={`project-card ${p.accent || ''} reveal`} 
              key={p.id} 
              onMouseMove={onMove} 
              onMouseLeave={reset}
            >
              ...
              <div className="project-main">
                <div className="project-visual">
                  ...
                  <Sparkles className="visual-spark" size={24} />
                </div>
                
                <div className="project-info">
                  <p className="status">{p.status} · {p.year}</p>
                  <h3>{p.title}</h3>
                  <p>{p.description}</p>
                  <div className="chips">
